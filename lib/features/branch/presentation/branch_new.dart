...
class _SidebarXExampleAppState extends State<BranchPage> {
  ...
  void _branchListener(BuildContext context, BranchState branchState) {
    if (branchState.stateStatus == StateStatus.error) {
      SnackBarUtils.errorSnackBar(branchState.errorMessage, context);
    }
  }
}
